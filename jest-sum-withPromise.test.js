...
const sumAnimals = require('./jest-sum-withPromise');
...
test('sum all dogs', () => {
    ...
    sumAnimals(animals, 'dog').then(result => expect(result).toBeGreaterThan(0));
    sumAnimals(animals, 'dog').then(result => expect(result).toBeLessThan(1000));
